...
import Bar from './molecules/BarChart'
    ...
    return (
      <div className="App">
        ...
        <Navbar collapseOnSelect expand="lg" bg="dark" variant="dark">
                ...
                <Modal.Body>
                    {
                        ...
                        <LoginForm {...this.state} handleChange={this.handleChange} handleSubmit={this.handleSubmit} handleIsLogin={this.props.handleIsLogin}/> : 
          ...
          {
            this.state.isLoggedIn ? <Bar/> : <div></div>
          }
      </div>
    );
  }
